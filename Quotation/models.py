...
class AddressExtension(models.Model):
    ...
    #added by millan on 29-09-2022
    BillToRemark = models.TextField(blank=True)
    ShipToRemark = models.TextField(blank=True)
    #added by millan on 29-09-2022
...
class QuotStatusRemarks(models.Model):
    QuotationID       = models.CharField(max_length=5, blank=True)
...
class QuotAttachments(models.Model):
    QuotationID     = models.CharField(max_length=5, blank=True)
