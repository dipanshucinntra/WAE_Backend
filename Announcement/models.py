...
class CampaignSet(models.Model):
    ...
    CampaignSetOwner = models.ForeignKey(Employee, to_field="SalesEmployeeCode", on_delete=models.CASCADE, related_name="AnnoCampaignSetOwner")
    ...
    EmpDep = models.CharField(max_length=250, blank=True)
    EmpSubDep = models.CharField(max_length=250, blank=True)
    ...
    CreateBy = models.ForeignKey(Employee, to_field="SalesEmployeeCode", on_delete=models.CASCADE, related_name="AnnoCreateBy")
...
class Campaign(models.Model):
    ...
    CampaignOwner = models.ForeignKey(Employee, to_field="SalesEmployeeCode", on_delete=models.CASCADE, related_name="AnnoCampaignOwner")    
